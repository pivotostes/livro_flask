...
class Config(object):
    ...
    APP = None
    SQLALCHEMY_DATABASE_URI = "mysql+mysqldb://pivotostes:Pit#220588@127.0.0.1:3306/livro_flask"
...
class TestingConfig(Config):
    ...
    DEBUG = True
    IP_HOST = 'localhost'
    # Aqui geralmente é um IP de um servidor na nuvem e não o endereço da
    # máquina local
    PORT_HOST = 5000
    URL_MAIN = 'http://%s:%s/' % (IP_HOST, PORT_HOST)
